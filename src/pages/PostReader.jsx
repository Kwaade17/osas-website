...
export default function PostReader() {
  ...
  // 1. THE DECODER FIX: 
  // We swap all non-breaking spaces for standard spaces inside the HTML string,
  // allowing the browser's layout engine to wrap lines naturally at word boundaries!
  ...
  return (
    <article className="min-h-screen bg-slate-50/50 py-12 px-4 md:px-6 overflow-x-hidden">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* HTML Text Area with cleanContent */}
        <div 
          className="rich-text-viewer text-slate-600 leading-relaxed font-medium text-sm md:text-base space-y-5 bg-white border border-slate-100 rounded-3xl p-6 md:p-10 shadow-xs w-full"
